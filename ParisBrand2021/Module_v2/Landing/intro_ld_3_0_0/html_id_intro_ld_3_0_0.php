<?php 
	...
	$content .= '
    <section id="" class="intro_ld_3_0_0">
        <div class="intro_ld_3_0_0_bg">
            <picture>
                <source media="(min-width:600px)" srcset="images/intro_ld_3_0_0-bg.jpg">
                <img src="images/intro_ld_3_0_0-bg-m.jpg" alt="">
            </picture>
        </div>
        <div class="container">
            <div class="intro_ld_3_0_0_box">
                <div class="row">
                    <div class="col-md-6">
                        <div class="intro_ld_3_0_0_title">
                            <picture>
                                <source media="(min-width:600px)" srcset="images/intro_ld_3_0_0-title.png">
                                <img src="images/intro_ld_3_0_0-title-m.png" alt="">
                            </picture>
                        </div>
                        <ul>
