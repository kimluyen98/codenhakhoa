...
<?php
    ...
    $path = $path.'/Module_v2/Landing/popup_call_1_1_0/';
?>
            ...
            <div class="popup_call_1_1_0_box">
                <article>
                    <div class="popup_call_1_1_0_header">
                        ...
                        <div class="popup_call_1_1_0_pop-note">Gọi ngay để được tư vấn & đặt lịch hẹn</div>
                        ...
                        <div class="popup_call_1_1_0_header">
                            <div class="popup_call_1_1_0_header-note">Hoặc để lại số điện thoại của bạn<br>để nhận cuộc gọi từ Nha Khoa Paris</div>
                        </div>
                    </div>
                    <div class="popup_call_1_1_0_content">
                        <div>
                            <div style="display:none">
                                <input id="iname" name="iname" type="text" required placeholder="* Họ tên:" value="Yêu Cầu Gọi Lại" style="display:none">
                                <input id="iemail" name="iemail" type="email" required placeholder="* Email:" value="yeucaugoilai@cskh.vn" style="display:none">
                                <textarea placeholder="Dịch vụ quan tâm: " rows="1" cols="1" id="itext" name="itext"  value="Yêu Cầu Gọi lại" style="display:none"></textarea>
                                <input type="hidden" id="gclid_field" name="gclid_field" value="">
                            </div>
                            <input id="imob" name="imob" type="textbox" placeholder="Số điện thoại của bạn*:">
                        </div>
                        <div>
                            <input id="pop_sent" onclick="ants_send_contact(this);" type="button" value="Yêu Cầu Gọi Lại">
                        </div>
                    </div>
