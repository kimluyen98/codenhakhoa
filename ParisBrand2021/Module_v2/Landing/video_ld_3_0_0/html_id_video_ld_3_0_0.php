<?php 
    ...
    $path = $path.'/Module_v2/Landing/video_ld_3_0_0';
	$content .= '
    <section id="" class="video_ld_3_0_0">
        <div class="container">
            <div class="video_ld_3_0_0_title">
                KHÁCH HÀNG NÓI GÌ VỀ NHA KHOA PARIS
            </div>
            <div class="video_ld_3_0_0_box">
                <div class="video_ld_3_0_0_boxL">
                    <a href="" class="modal-clip" data-video="">
                        <img class="lazy" data-src="images/video-1.jpg">
                    </a>
                    <p>Sở hữu nụ cười tỏa sáng cùng Leo (Zero 9)</p>
                </div>
                <div class="video_ld_3_0_0_boxR">
                    <div class="video_ld_3_0_0_item">
                        <a href="" class="modal-clip" data-video="">
