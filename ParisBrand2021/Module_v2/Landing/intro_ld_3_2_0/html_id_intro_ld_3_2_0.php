<?php 
	...
	$content .= '
    <section id="" class="intro_ld_3_2_0">
        <div class="intro_ld_3_2_0_bg">
            <picture>
                <source media="(min-width:600px)" srcset="images/intro_ld_3_2_0-bg.jpg">
                <img src="images/intro_ld_3_2_0-bg-m.jpg" alt="">
            </picture>
        </div>
        <div class="container">
            <div class="intro_ld_3_2_0_box">
                <div class="intro_ld_3_2_0_title">
                    <picture>
                        <source media="(min-width:600px)" srcset="images/intro_ld_3_2_0-title.png">
                        <img src="images/intro_ld_3_2_0-title.png" alt="">
                    </picture>
                </div>
                <div class="intro_ld_3_2_0_box1">
                    <ul>
