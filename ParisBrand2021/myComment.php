				...
				<div class="pcm__main pcm__main_a">
					...
					if(!function_exists('loopNumber')){
						...
						foreach ( $comments as $comment ) :
							...
							if($avartar=="") $avartar="/wp-content/themes/dichvu/media/images/avatar.jpg";
							...
							foreach ( $comments_sub as $comment_sub ){
								...
								if($avartar2=="") $avartar2="/wp-content/themes/dichvu/media/images/avatar.jpg";
								...
								if(strpos($comment_content, "shide",0)!==false){
									...
									$comment_substr=$comment_substr.'	
										<div class="pcm__footer">
											<div class="pcm__user">
												<div class="user_pic"><img src="'.$avartar2.'" alt=""></div>
												<div class="user_ct">
							...
							echo '
								<article>
									...
									if(strpos($comment_content, "shide",0)!==false){	
										...
										<div class="pcm__footer">
											<div class="pcm__user">
												<div class="user_pic"><img src="'.$avartar.'" alt=""></div>
												<div class="user_ct">
					...
					<article>
						...
						<div class="pop_fr">
							<div>
								...
								<input id="txtcpostId" name="txtcpostId" value="<?php echo get_the_ID(); ?>" type="textbox" style="display:none"></input>
			...
			<div class="pop_box">
				<article>
					<div class="pop_hd">
						...
						<div class="desc">Nha khoa Paris đã nhận được ý kiến của bạn. Chúng tôi sẽ phản hồi lại bạn trong thời gian sớm nhất. Xin cảm ơn !</div>
					</div>
					<a id="close">
						<svg viewbox="0 0 40 40">
							<path class="close-x" d="M 10,10 L 30,30 M 30,10 L 10,30" />
